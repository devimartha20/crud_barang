...
urlpatterns = [
    ...
    path('pemasok/detail/<int:pk>/', views.pemasok_detail, name='pemasok_detail'),
    ...
    path('gudang/detail/<int:pk>/', views.gudang_detail, name='gudang_detail'),
    ...
    path('barang/detail/<int:pk>/', views.barang_detail, name='barang_detail'),
    ...
    path('po/detail/<int:pk>/', views.po_detail, name='po_detail'),
    ...
    path('terima-barang/detail/<int:pk>/', views.terima_barang_detail, name='terima_barang_detail'),
